...
a = Analysis(
    ...
    datas=[('src/gazebo_mcp', 'gazebo_mcp'), ('web_sota/backend', 'web_sota/backend')],
...
_keep_dist = ['fastmcp-', 'mcp-', 'gazebo-', 'prefab_ui-', 'opentelemetry-', 'email_validator-']
...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, a.binaries, a.zipfiles, a.datas, name='gazebo-mcp-backend', debug=False, strip=False, upx=False, upx_exclude=[], runtime_tmpdir=None, console=False)
