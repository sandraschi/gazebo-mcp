...
const FLEET: FleetRepo[] = [
  ...
  {
    name: "yahboom-mcp",
    url: "http://127.0.0.1:10893",
    port: "10893",
    role: "Physical robot control",
  },
  {
    name: "unity3d-mcp",
    url: "http://127.0.0.1:10831",
    port: "10831",
    role: "3D visualization",
  },
  {
    name: "resonite-mcp",
    url: "http://127.0.0.1:10979",
    port: "10979",
    role: "VR spatial sync",
  },
  {
    name: "freecad-mcp",
    url: "http://127.0.0.1:10945",
    port: "10945",
    role: "CAD model export",
  },
];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <p className="text-muted-foreground">
        Gazebo simulation bridge connected to the robotics fleet. Each repo
        below syncs with Gazebo simulation state.
      </p>
